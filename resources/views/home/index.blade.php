...
@section('script')
    <script>
        $('.variation-select').on('change', function () {
            ...
            let variation_price_div = $('.variation-price') ;
            variation_price_div.empty();
            if(variation.is_sale){
                ...
                variation_price_div.append(spanSale);
                variation_price_div.append(spanPrice);
                ...
                variation_price_div.append(price);
            }
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                        <div class="slider-single-img slider-animated-1">
                            <img class="animated" src="{{asset(env('PRODUCT_BANNER_IMAGES_UPLOAD_PATH').$slider->image)}}" alt="{{$slider->title}}" />
                        </div>
                    </div>
                </div>
            </div>
...
<div class="banner-area pt-100 pb-65">
    <div class="container">
        <div class="row">
            @foreach ($index_top_banners->chunk(3)->first() as $top_banner )

            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30 scroll-zoom">
                    <a href="{{$top_banner->button_link}}">
                        <img class="animated" src="{{asset(env('PRODUCT_BANNER_IMAGES_UPLOAD_PATH').$top_banner->image)}}"
                            alt="{{$top_banner->image}}" />
                    </a>
                    <div class="banner-content-2 banner-position-5">
                        <h4>{{$top_banner->text}}</h4>
                    </div>
                </div>
            </div>
            @endforeach
            @foreach ($index_top_banners->chunk(3)->last() as $top_banner )
            ...
            <div class="col-lg-6 col-md-6">
                <div class="single-banner mb-30 scroll-zoom">
                    ...
                    <div class="banner-content banner-position-6 text-right">
                        <h3>
                            <i class="{{$top_banner->button_icon}}"></i>
                            {{$top_banner->text}}
                        </h3>
                        <a href="{{$top_banner->button_link}}">
                            {{$top_banner->button_text}}
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="ht-product-inner">
                            ...
                            <div class="ht-product-content">
                                <div class="ht-product-content-inner">
                                    ...
                                    <div class="ht-product-ratting-wrap" id="review">
                                        <div
                                            data-rating-stars="5"
                                            data-rating-readonly="ture"
...
<div class="testimonial-area pt-80 pb-95 section-margin-1 mb-5"
            ...
            <div class="col-lg-10 ml-auto mr-auto">
                <div class="testimonial-active owl-carousel nav-style-1">
                    <div class="single-testimonial text-center">
                        ...
                        <p>
                            همه میگن ویندوز رابط کاربری خوبی نداره و اینو فقط ادمای پولدار با مغز های توخالی میگن
                            اکثرشون از هم واسه دیدن نتفلیکس و واسه پز دادن میرن محصولات مک رو میخرن
                            این ویندوزه که مرد میدانه و بدرد همجا میخوره حتی اینو خود استیو جابز هم میدونست واس
                            همین با من دعوا داشت خدا بیامرز
                        </p>
                    ...
                    <div class="single-testimonial text-center">
                        ...
                        <p>
                            ناسا مسخرس اگه دلتون خواست راکت هوا کنید به من یه زنگ بزنید
                        </p>
                        <div class="client-info">
                            <img src="{{asset('images/home/testi.png')}}" alt="Some Comment" />
                            <h5>ایلان ماسک</h5>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 text-right">
                <div class="single-banner mb-30 scroll-zoom">
                    <a href="{{$banner->button_link}}"><img src="{{asset(env('PRODUCT_BANNER_IMAGES_UPLOAD_PATH').$banner->image)}}" alt="{{$banner->image}}" /></a>
                        ...
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            <div class="tab-content quickview-big-img">
                                ...
                                <div id="pro-{{$image->id}}" class="tab-pane fade">
                                    <img src="{{asset(env('PRODUCT_IMAGES_UPLOAD_PATH').$image->image)}}" alt="{{$product->name}}" />
                                </div>
                                @endforeach
                            </div>
