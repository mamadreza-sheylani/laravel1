...
@section('script')
    <script>
        $('.sorting-nice-select').niceSelect();
        ...
        function filter(){
            ...
            let search = $('#search-side-bar').val();
            if(search == ""){
        ...
        $('#filter-form').on('submit', function (e) {
                ...
                let url = current_url+'?'+decodeURIComponent($(this).serialize());
...
@section('content')
        ...
        <div class="shop-area pt-10 pb-100" >
            <div class="container-fluid">
                <div class="row flex-row-reverse text-right">
                    ...
                    <!-- sidebar -->
                    <div class="col-lg-3 order-2 order-sm-2 order-md-1" style="background-color: #f6f6f6">
                        <div class="sidebar-style mr-30">
                            <div class="sidebar-widget">
                                <div class="pro-sidebar-search mb-50 mt-25">
                                    <div class="pro-sidebar-search-form">
                                        <input type="text" id="search-side-bar" autocomplete="off" placeholder="... جستجو "
                                        value="{{request()->has('s') ? request()->s : '' }}"
                                        >
                        ...
                        <div class="shop-top-bar" style="direction: rtl;">
                            ...
                            <div class="select-showing-wrap">
                                <div class="shop-select">
                                    <select id="sort-by" class="sorting-nice-select" onchange="filter()">
                                            ...
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    ...
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li>
                                                                <a href="{{route('home.products.show' , ['product' => $product->slug])}}" data-toggle="modal" data-target="#productModal-{{$product->id}}"><i
    ...
    <form id="filter-form">
        ...
        <input type="hidden" name="s" id="filter-search">
    </form>
    <!-- Modal -->
    @foreach ($products as $product )
                            ...
                            <div class="product-details-content quickview-content">
                                ...
                                <div class="pro-details-size-color text-right">
                                    ...
                                    <div class="pro-details-size w-50">
                                        ...
                                        <select class="form-control variation-select" id="">
