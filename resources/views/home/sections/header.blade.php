                        ...
                        <nav>
                            <ul>
                                <li class="angle-shape">
                                    <a href="{{route('home.about_us')}}">درباره ما</a>
                                </li>
                                    ...
                                    <ul class="mega-menu">
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{route('home.categories.show' , ['category'=>$child->slug])}}">{{$child->name}}</a></li>
                                                @endforeach
                                    ...
                                    <li class="single-shopping-cart">
                                        ...
                                        <div class="shopping-cart-img">
                                            <a href="{{route('home.products.show' , ['product'=>$item->associatedModel->slug])}}">
                                                <img alt="{{$item->name}}" src="{{asset(env('PRODUCT_IMAGES_UPLOAD_PATH').$item->associatedModel->primary_image)}}" width="20" />
                                            </a>
                        ...
                        <div class="setting-wrap">
                            ...
                            <div class="setting-content">
                                <ul class="text-right">
                                    ...
                                    <li><a href="/logout" class="text-danger" >خروج</a></li>
                                    @else
            ...
            <div class="row align-items-center">
                <div class="col-6">
                    <div class="mobile-logo">
                        <a href="index.html">
                            <h4 class="font-weight-bold">My Shop</h4>
                        </a>
                    </div>
                </div>
                <div class="col-6">
