            ...
            <form action="{{ route('admin.categories.update' , ['category'=>$category->id]) }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control" id="slug" value="{{$category->name}}" name="slug" type="text">
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control selectpicker" id="is_active" name="is_active">
                            <option value="1" {{$category->getRawOriginal('is_active') ==1  ? 'selected' : ''}} >فعال</option>
                            <option value="0" {{$category->getRawOriginal('is_active') == 0 ? 'selected' : ''}} >غیرفعال</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select id="attributeSelect" name="attribute_ids[]" class="form-control" multiple data-live-search="true">
                            @foreach ($attributes as $attribute)
                                ...
                                {{in_array($attribute->id , $category->attribute()->pluck('id')->toArray()) ? 'selected' : ''}}
