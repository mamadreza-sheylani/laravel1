...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-md-5 bg-white">
            <div class="mb-4">
                <h5 class="font-weight-bold">ایجاد بنر جدید
                </h5>
            </div>
            <hr>
            ...
            <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control" id="text" name="text" type="text" autocomplete="off">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="priority">الویت</label>
                        <input class="form-control" id="priority" name="priority" type="text" autocomplete="off">
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control" id="banner_type" name="banner_type" type="text" autocomplete="off">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="button_text">متن دکمه</label>
                        <input class="form-control" id="button_text" name="button_text" type="text" autocomplete="off">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="button_link"> لینک دکمه</label>
                        <input class="form-control" id="button_link" name="button_link" type="text" autocomplete="off">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="button_icon">آیکون دکمه</label>
                        <input class="form-control" id="button_icon" name="button_icon" type="text" autocomplete="off">
                    </div>
