                ...
                <tbody>
                    @foreach ($brands as $key=> $brand )
                        <tr>
                            ...
                            <th>
                                <a class="btn btn-sm btn-outline-success" href="{{route('admin.brands.show' , ['brand'=>$brand->id])}}">
                                    نمایش
                                    <i class="fa fa-search"></i>
                                </a>
                                <a class="btn btn-sm btn-outline-primary mr-3" href="{{route('admin.brands.edit' , ['brand'=>$brand->id])}}">
                                    ویرایش
